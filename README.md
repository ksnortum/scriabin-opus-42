# scriabin-opus-42
[LilyPond](https://lilypond.org/) engraving source files used to create Scriabin's Eight Etudes, opus 42.
...
The PDF and MIDI files can be created by issuing the following command in the directory this file is in (assuming you have `lilypond` in your PATH variable):
        ...
        lilypond etudes-op42-book.ly

To create a smaller PDF, try:

        lilypond -dno-point-and-click etudes-op42-book.ly

You may also [download the latest release](https://github.com/ksnortum/scriabin-opus-42/releases/latest) to get the compiled PDF and MIDI files.
